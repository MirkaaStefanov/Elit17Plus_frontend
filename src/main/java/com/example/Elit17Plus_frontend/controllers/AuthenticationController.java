...
import com.example.Elit17Plus_frontend.clients.AuthenticationClient;
import com.example.Elit17Plus_frontend.dtos.auth.AuthenticationRequest;
import com.example.Elit17Plus_frontend.dtos.auth.AuthenticationResponse;
import com.example.Elit17Plus_frontend.dtos.auth.PendingRequest;
import com.example.Elit17Plus_frontend.dtos.auth.RegisterRequest;
import com.example.Elit17Plus_frontend.session.SessionManager;
...
public class AuthenticationController {
    ...
    public ModelAndView register(RegisterRequest registerRequest, HttpServletRequest httpServletRequest) {
        ...
        try {
            ...
            // Check for pending POST request first
    ...
    public ModelAndView login(AuthenticationRequest authenticationRequest, HttpServletRequest httpServletRequest) {
        ...
        try {
            ...
            modelAndView.addObject("error", "Невалидно име или парола");
            modelAndView.addObject("loginRequest", authenticationRequest);
            return modelAndView;
        }
    }
